...
#    print("Processed points look like:", processed_points)
...
#    for i in acc_render:
#        if i < 0.2:
#            count_0_20 = count_0_20 + 1
#        elif i < 0.4:
#            count_20_40 = count_20_40 + 1
#        elif i < 0.6:
#            count_40_60 = count_40_60 + 1
#        elif i < 0.8:
#            count_60_80 = count_60_80 + 1
#        else:
#            count_80_100 = count_80_100 + 1

#    print("0_20 is",count_0_20)
#    print("20_40 is",count_20_40)
#    print("40_60 is",count_40_60)
#    print("60_80 is",count_60_80)
#    print("80_100 is",count_80_100)
...
#        print("colour_render is:", colour_render)
#        print("acc_render is:", acc_render)
        new_colour = torch.tensor([0.39, 0.52, 0.67], device=device).expand((acc_render.size()[0], 3))
        colour_render = colour_render + (1 - acc_render) * new_colour
        
#        for i in range(acc_render.size()[0]):
#            if (acc_render[i] < 0.9):
#                colour_render[i] = torch.tensor([0.4, 0.7, 1.0], dtype=dtype, device=device)
#        print("addition is:",(new_colo ur - acc_render))
#        print("colour_render is now:", colour_render)
