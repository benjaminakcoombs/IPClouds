...
/usr/bin/nvidia-smi
python3 /vol/bitbucket/bac21/IP/ip/pixel-nerf/train/trainNDC.py -n fullRenderNDC -c /vol/bitbucket/bac21/IP/ip/pixel-nerf/conf/exp/fullRender.conf -D /vol/bitbucket/bac21/IP/fullRender/ -V 1
uptime