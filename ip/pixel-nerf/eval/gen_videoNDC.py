...
dset = get_split_dataset(
    args.dataset_format, args.datadir, want_split=args.split, training=False, ndc = True
)
...
#pose_inv_0 = np.linalg.inv(poses[0])
#pose_inv_1 = np.linalg.inv(poses[1])
#middle = (pose_inv_0 - pose_inv_1)/2
##pose_inv_0 = torch.from_numpy(pose_inv_0)
#pose_inv_1 = torch.from_numpy(pose_inv_1)
#middle = torch.from_numpy(middle)
#ender_poses = torch.stack([pose_inv_0 + middle, pose_inv_0, pose_inv_1 + middle, pose_inv_1, pose_inv_1 - middle])
...
#print("render poses:", render_poses)
#print("args scale is:", args.scale)
#print("c is", c)
#print("focal is", focal)
#print("W is", W)
##print("H is", H)
#print("z near is", z_near)
#print("z far is", z_far)
