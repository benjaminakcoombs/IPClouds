...
/usr/bin/nvidia-smi
python3 /vol/bitbucket/bac21/steak-generation/ip/pixel-nerf/train/trainNDC.py -n timelapseNDC -c /vol/bitbucket/bac21/steak-generation/ip/pixel-nerf/conf/exp/fullRender.conf -D /vol/bitbucket/bac21/steak-generation/timelapse -V 1
uptime